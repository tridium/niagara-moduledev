...
function Resolver(reg, config) {
  ...
  function modulePathToModuleDev(modInfo) {
    ...
    function doResolve(modulePath) {
      return new Promise(function (resolve, reject) {
        (function fromProfile(i) {
          ...
          const filePath = path.join(dir, moduleName + profiles[i],
            srcFolder, modulePath);
    ...
    //if we have a double extension specified, try and resolve without .js first
    if (modulePath.match(/\.\w+\.js$/)) {
